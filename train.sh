...
./baseline.py --pretrain --train --sardir $srcdir/train/SAR-Intensity --opticaldir $srcdir/train/PS-RGB --labeldir $srcdir/train/Buildings --rotationfile $srcdir/train/SummaryData/SAR_orientations.txt --maskdir $dstdir/masks --sarprocdir $dstdir/sartrain --opticalprocdir $dstdir/optical --traincsv $dstdir/train.csv --validcsv $dstdir/valid.csv --rotate --mintrainsize 20
